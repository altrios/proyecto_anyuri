...
class CatalogoController extends Controller
{
	 ...
	 */
	/*public function actionCreate()//// original
	{
		$model=new Catalogo;
	...
	public function actionCreate() //tercero/////////////////
    {
    	$model=new catalogo();
        ...
        if(isset($_POST["catalogo"]))
        {
            ...
            if($model->validate())
            {
               ...
               {
                    $file->saveAs(Yii::getPathOfAlias("webroot")."/images/".$name);
               }else
               {
...
/*	{
        $model=new catalogo;  // este es el modelo relacionado a la tabla
        if(isset($_POST['catalogo']))
        {
            ...
            if($model->save())
            {
                $uploadedFile->save(Yii::app()->basePath.'/anyuri/images'.$fileName);  // la img se subirá a la carpeta raiz /catalogo/
    ...
    public function actionDisplaySavedImage()
{
	...
	/*public function actionUpdate($id)// original
	{
		$model=$this->loadModel($id);
	...
	public function actionUpdate($id)
    {
        ...
        if(isset($_POST['catalogo']))
        {
            ...
            if($model->save())
            {
                ...
                {
                    $uploadedFile->saveAs(Yii::app()->basePath.'/../catalogo/'.$model->img);
                }
                $this->redirect(array('view'));
            }
