...
<html lang="es">
  <head>
    ...
    <!-- Fav and touch icons -->
    <?php ?><link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo Yii::app()->theme->baseUrl;?>/ico/apple-touch-icon-144-precomposed.png">
    ...
    <link rel="shortcut icon" href="<?php echo Yii::app()->theme->baseUrl;?>/ico/favicon.png"><?php ?>
  </head>
  <body>
...
<?php /*?><section class="footer-credits">
    <div class="container">
        <ul class="clearfix">
